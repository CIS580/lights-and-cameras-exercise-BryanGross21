...
namespace LightingAndCamerasExample
{
	public class Crate
	{
		...
		void InitializeEffect()
		{
			...
			//Sets up the first light in the scene
			effect.DirectionalLight0.Enabled = true;
			//The direction the light is coming from with this instance it would be up and to the left
			effect.DirectionalLight0.Direction = new Vector3(1f, -1f, 1f);
			//These Vector3s set-up the lighting colors in a (R,G,B) format
			...
			//The direction the light is coming from with this instance it would be up and to the right
			effect.DirectionalLight1.Direction = new Vector3(-1f, -1f, 0f);
			//These Vector3s set-up the lighting colors in a (R,G,B) format
			effect.DirectionalLight1.DiffuseColor = new Vector3(0, .8f, 0);
			effect.DirectionalLight1.SpecularColor = new Vector3(0, 0.4f, 0.4f);
